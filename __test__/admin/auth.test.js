...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Kailee.Schowalter',
      password: 'zRnHW6SZTTmJf7S',
      email: 'Josefa6@gmail.com',
      name: 'Wilma McLaughlin',
      userType: 917,
      mobileNo: '1-500-581-8065 x68165',
      resetPasswordLink: {},
      loginRetryLimit: 721,
      loginReactiveTime: '2022-07-13T15:33:32.453Z',
      id: '6241631326c7c5003182335d'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Shaina78',
        'password':'Zww4sRh91usaIhh',
        'email':'Aleen32@yahoo.com',
        'name':'Brandy Goldner',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'1-362-537-4659',
