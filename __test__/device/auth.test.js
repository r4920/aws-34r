...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Valentina.Marvin63',
      password: 'bG1ytFoL2NQoMKX',
      email: 'Marlen_Paucek@hotmail.com',
      name: 'Hope Terry',
      userType: 262,
      mobileNo: '(857) 420-9719 x3536',
      resetPasswordLink: {},
      loginRetryLimit: 513,
      loginReactiveTime: '2022-11-08T01:28:08.220Z',
      id: '6241631326c7c500318233de'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Adolph64',
        'password':'95aPQbnuLsH7ThY',
        'email':'Lily23@yahoo.com',
        'name':'Lawrence Borer I',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'743-546-2074',
